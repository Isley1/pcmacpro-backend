// Configuration file for FixHub repair form
// Edit these values to customize the form behavior

module.exports = {
  // Email Settings - CHANGE THIS TO YOUR EMAIL ADDRESS
  REPAIR_EMAIL: "henryisleyt@gmail.com",  // Email where repair requests will be sent
  SENDER_EMAIL: "henryisleyt@gmail.com",   // Email address used to send the email
